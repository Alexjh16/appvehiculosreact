...
const ListaCarros = () => {
    ...
    return (
        <>
            <h2 class="text-pretty text-gray-400 font-serif text-center p-11 text-5xl ">Listado de carros | Flowbite</h2>
            <div class="grid  grid-cols-3 gap-4 p-5 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                <div class="flex flex-row w-auto">
                    <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow-sm ">
                        <a href="#">
                            <img class="p-8 rounded-t-lg" src="https://www.motortrend.com/uploads/sites/11/2019/07/Lotus-16.jpg?w=768&width=768&q=75&format=webp" alt="product image" />
                        </a>
                        <div class="px-5 pb-5">
                            <a href="#">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <a href="#" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 ">Add to cart</a>
                            </div>
                        </div>
                    </div>
